...
void LCD_WRITE_STR(char s[], int size, uint8_t x, uint8_t y);

//void LCDSendAnInteger(int integer, uint8_t numDigits);
void LCDSendAnInteger(int integer, uint8_t numDigits, uint8_t x, uint8_t y);

//void LCDSendAFloat(float f, uint8_t numDigits);
void LCDSendAFloat(float f, uint8_t numDigits, uint8_t x, uint8_t y);
